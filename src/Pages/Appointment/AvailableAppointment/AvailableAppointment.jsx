...
const AvailableAppointment = ({ selectedDate }) => {
    ...
    const { data: availableAppointment = [], refetch } = useQuery({
        ...
        queryFn: async () => {
            const res = await fetch(`https://doctors-portal-server1.vercel.app/availableAppointment?date=${date}`)
    ...
    /* useEffect(() => {
        ...
        // fetch('https://doctors-portal-server1.vercel.app/availableAppointment')
            .then(res => res.json())
